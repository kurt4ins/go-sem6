...
type TaskServiceClient interface {
	CreateTask(ctx context.Context, in *CreateTaskReq, opts ...grpc.CallOption) (*Task, error)
	ListTasks(ctx context.Context, in *ListTasksReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Task], error)
}
...
func (c *taskServiceClient) CreateTask(ctx context.Context, in *CreateTaskReq, opts ...grpc.CallOption) (*Task, error) {
...
func (c *taskServiceClient) ListTasks(ctx context.Context, in *ListTasksReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Task], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[0], TaskService_ListTasks_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ListTasksReq, Task]{ClientStream: stream}
...
type TaskServiceServer interface {
	...
	ListTasks(*ListTasksReq, grpc.ServerStreamingServer[Task]) error
...
func (UnimplementedTaskServiceServer) CreateTask(context.Context, *CreateTaskReq) (*Task, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateTask not implemented")
}
func (UnimplementedTaskServiceServer) ListTasks(*ListTasksReq, grpc.ServerStreamingServer[Task]) error {
...
func _TaskService_ListTasks_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TaskServiceServer).ListTasks(m, &grpc.GenericServerStream[ListTasksReq, Task]{ServerStream: stream})
}
